export class CardCantCargarStock {
  constructor(title, subtitle, cancelText, cargarText, showHeader = true) {
      ...
      this.armarCardCantCargarStock();
  }

  armarCardCantCargarStock() {
    this.agregarCss();
...
// Usage
const miCard = new CardCantCargarStock('Producto--bla-blabla', 'Cantidad', 'Cancelar', 'Cargar');
...
// For a card without header
const miCardSinHeader = new CardCantCargarStock('', 'Cantidad', 'Cancelar', 'Cargar', false);
mainElement.appendChild(miCardSinHeader.armarCardCantCargarStock());