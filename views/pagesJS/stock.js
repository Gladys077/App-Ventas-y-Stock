...
export class PlanillaStock {
    ...
    createHeader=()=>{
        this.header = new Header("Stock", iconoVolver, iconoMenu,null,function(){ navigateToMenu('stock'); });
    ...
    createMostrarMainNav= ()=>{
        ...
        this.mainNav =  new MostrarMainNav("Stock", "Bajo stock", "Sin movimiento", true,false,false)
