...
export class PlanillaStock {
    ...
    createHeader=()=>{
        this.header = new Header("Stock bajo", iconoVolver, iconoMenu,null,function(){ navigateToMenu('stock'); });
    ...
    createMostrarMainNav= ()=>{
        ...
        this.mainNav =  new MostrarMainNav("Stock", "Bajo stock", "Sin movimiento",false,true,false)
